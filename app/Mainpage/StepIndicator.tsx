...
const StepIndicator = ({
  ...
  return (
    <div className="flex items-start justify-center w-full max-w-3xl mx-auto mb-12">
      {steps.map((step, index) => {
        // ✅ In edit mode every step is clickable; otherwise only past steps.
            ...
            <div className="flex flex-col items-center relative min-w-[100px]">
              ...
              >
                <div
                  ...
                  style={{
                    backgroundColor:
                      currentStep >= step.id ? "#404040" : "white",
                    borderColor:
                      currentStep >= step.id ? "#404040" : "#A6A6A6",
                  }}
                >
                  {currentStep > step.id ? (
                    <Check className="w-3.5 h-3.5 stroke-[3] text-white" />
            ...
            {index < steps.length - 1 && (
              <div className="flex-1 h-[2px] -ml-6 -mr-6 mt-[34px] bg-gray-100 relative">
                ...
                <div
                  ...
                  style={{
                    backgroundColor:
                      currentStep > step.id ? "#262626" : "#A6A6A6",
                    opacity: 0.3,
                  }}
                />
              </div>
