...
const UploadWholesalersStep = ({
  ...
  "ATLAND", "AUBURN", "AYTU BIOPHARMA", "BESSE", "BIORIDGE", "BLUPAX", "BONITA", 
  "CARDINAL", "COCHRAN WHOLESALE PHARMACEUTICAL", "DB DIAGNOSTICS", "DOCKSIDE PARTNERS", 
  "EXELTIS", "FFF ENTERPRISES", "GALT DIRECT", "GEMCO MEDICAL", "GENETCO", 
  "GLENVIEW PHARMA", "GREEN HILL TRADING", "GSK", "HEALTHSOURCE", "HYGEN PHARMACEUTICALS", 
  "ICS DIRECT", "INDEPENDENT PHARMACEUTICAL", "INTEGRAL RX", "IPC", "IPD", "IXTHUS", 
  "JAMRX", "JG", "JOURNEY", "KARES", "KEYSOURCE", "LANDMARK", "MAKS PHARMA", "MASTERS", 
  "MATCHRX", "MATRIX", "MCKESSON", "MODERNA DIRECT", "NETCOSTRX", "NEW SUPPLIER 1", 
  "NEW SUPPLIER 2", "NEW SUPPLIER 3", "NEW SUPPLIER 4", "NORTHEAST MEDICAL", "NUMED", 
  "OAK DRUGS", "PAYLESS", "PBA HEALTH", "PFIZER DIRECT", "PHARMSAVER", "PHARMSOURCE", 
  "PILL R HEALTH (340B)", "PRESCRIPTION SUPPLY", "PRIMED", "PRODIGY", "PRX WHOLESALE", 
  "QUALITY CARE", "QUEST PHARMACEUTICAL", "REPUBLIC", "RX MART", "RX ONE SHOP", 
  "RXPOST", "SAVEBIGRX", "SECOND SOURCE RX", "SEQIRUS", "SMART SOURCE", "SMITH DRUGS", 
  "SOUTH POINTE", "SPECTRUM", "STARTING INVENTORY 1", "STARTING INVENTORY 2", 
  "STARTING INVENTORY 3", "STERLING DISTRIBUTOR", "SURECOST", "TOPRX", "TRXADE", 
