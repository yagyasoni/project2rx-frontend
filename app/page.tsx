...
//               ],
//             ],
//             ["Company", ["About Us", "HIPAA Compliant"]],
//             [
//               "Legal",
...
const animationStyles = `
  ...
  .animate-horizontalScroll { animation: horizontalScroll 20s linear infinite; }
  ...
  .marquee-content.animate { animation: horizontalScroll 20s linear infinite; }
...
const Logo = () => (
  <div className="flex items-center">
    <div className="relative h-20 w-28 sm:h-24 sm:w-32 md:h-30 md:w-40 shrink-0">
      <Image
        src="/l1.png"
        alt="AuditProRx"
        fill
  ...
  return (
    <div className="fixed inset-0 z-50 mt-12 flex items-center justify-center bg-black/50 p-4 backdrop-blur-md">
      <div className="relative w-full max-w-md overflow-hidden rounded-lg border border-white/10 bg-[#0B0B0F]/95 shadow-[0_20px_80px_rgba(0,0,0,0.65)] animate-scaleIn">
        ...
        <div className="relative flex items-start justify-between border-b border-white/10 px-4 sm:px-6 py-5">
          <div>
        ...
        <div className="relative space-y-4 p-4 sm:p-6">
          ...
          >
            ...
            <div className="relative flex-1 min-w-0">
              <span className="text-[10px] sm:text-xs font-semibold uppercase tracking-[0.18em] text-white">
                WhatsApp &bull;
              </span>{" "}
              <span className="mt-1 text-xs sm:text-sm font-semibold text-white break-all">
                {phone}
              </span>
              <p className="mt-1 text-xs text-zinc-400">
                Instant support & quick responses
...
export default function Index() {
  ...
  const contactEmail = "auditprorx@gmail.com";
  const contactPhone = "+1 (551) 229-6466";
  ...
  return (
    <div className="min-h-screen bg-background text-foreground antialiased overflow-x-hidden">
      ...
      {/* NAV */}
      <header className="sticky top-0 z-50 border-b border-border/60 bg-background/80 backdrop-blur">
        <div className="mx-auto flex h-16 max-w-9xl items-center justify-between px-4 sm:px-6 lg:px-7">
          <Logo />
          <nav className="hidden items-center gap-6 xl:gap-8 text-sm text-muted-foreground lg:flex">
            {navLinks.map((l) => (
              <a
                key={l.label}
                href={l.href}
          ...
          <div className="flex items-center gap-3 sm:gap-5 lg:gap-8">
            ...
            <button
              onClick={scheduleConsultation}
              className="hidden sm:inline-flex rounded-lg bg-gradient-to-b from-zinc-100 to-zinc-300 px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium text-background shadow-[inset_0_1px_0_rgba(255,255,255,0.4)] hover:from-white animate-fadeInUp stagger-0 whitespace-nowrap"
            >
              Schedule a Consultation
            </button>
            <button
              ...
              className="grid lg:hidden h-10 w-10 place-items-center rounded-md border border-border bg-surface text-muted-foreground hover:text-foreground"
            >
              {isMobileNavOpen ? (
                <X className="h-5 w-5" />
              ) : (
        ...
        {isMobileNavOpen && (
          <div className="lg:hidden border-t border-border/60 bg-background/95 backdrop-blur">
            <nav className="mx-auto flex max-w-9xl flex-col gap-1 px-4 sm:px-6 py-4 text-sm">
              {navLinks.map((l) => (
                <a
                  key={l.label}
                  href={l.href}
                  onClick={() => setIsMobileNavOpen(false)}
                  className="rounded-md px-3 py-2 text-muted-foreground hover:bg-surface hover:text-foreground transition"
                >
                  {l.label}
                </a>
              ))}
              <a
                href="/auth"
                onClick={() => setIsMobileNavOpen(false)}
                className="sm:hidden rounded-md px-3 py-2 text-muted-foreground hover:bg-surface hover:text-foreground transition"
              >
                Log In
              </a>
              <button
                ...
                className="sm:hidden mt-2 rounded-lg bg-gradient-to-b from-zinc-100 to-zinc-300 px-4 py-2.5 text-sm font-medium text-background"
              >
                Schedule a Consultation
              </button>
            </nav>
      ...
      <section className="relative overflow-hidden border-b border-border/60">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(255,255,255,0.06),transparent_60%)]" />
        <div className="relative mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-7 pt-12 sm:pt-16 lg:pt-20 pb-12 sm:pb-16 text-center">
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
            <div
              className="absolute top-[20%] left-0 w-[1600px] h-[1600px] rounded-full blur-[220px]"
              style={{
          ...
          <Pill>Enterprise Pharmacy Operations Platform</Pill>
          <h1 className="mx-auto mt-6 sm:mt-8 max-w-5xl text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-semibold leading-[1.1] tracking-tight animate-fadeInUp stagger-1">
            Precision Audit Intelligence
            <br />
            <span className="text-muted-foreground/70 animate-fadeInUp stagger-2">
              for Modern Pharmacies
          ...
          <p className="mx-auto mt-5 sm:mt-7 max-w-3xl text-sm sm:text-[15px] leading-relaxed text-muted-foreground animate-fadeInUp stagger-3 px-2">
            Automate audit workflows, protect revenue, access drug intelligence,
            and collaborate across pharmacy networks — all in one platform built
            for pharmacy teams.
          </p>
          <div className="mt-7 sm:mt-9 flex flex-col sm:flex-row items-center justify-center gap-3 animate-fadeInUp stagger-4">
            <button
              onClick={scheduleConsultation}
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-lg bg-gradient-to-b from-zinc-100 to-zinc-300 px-5 py-3 text-sm font-medium text-background shadow-[inset_0_1px_0_rgba(255,255,255,0.4)]"
            >
              Schedule a Consultation <ArrowRight className="h-4 w-4" />
            </button>
            <a
              href="#"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-lg border border-border bg-surface px-5 py-3 text-sm text-foreground hover:bg-surface-2"
            >
              <Play className="h-4 w-4" /> Watch Overview
            </a>
          </div>
          <div className="mt-7 sm:mt-9 flex flex-wrap items-center justify-center gap-3 sm:gap-4 text-xs sm:text-sm text-muted-foreground animate-fadeInUp stagger-5">
            <div className="flex -space-x-2">
              {[
                { initial: "UC", gradients: "from-blue-400 to-cyan-300" },
                { initial: "IA", gradients: "from-amber-300 to-yellow-500" },
          ...
          {/* Dashboard Mock */}
          <div className="mx-auto mt-10 sm:mt-16 max-w-5xl overflow-hidden rounded-2xl border border-border bg-surface shadow-2xl animate-scaleIn stagger-6">
            <div className="flex items-center gap-2 border-b border-border bg-surface-2 px-3 sm:px-4 py-3">
              <div className="flex gap-1.5">
                <span className="h-3 w-3 rounded-full bg-zinc-700" />
                <span className="h-3 w-3 rounded-full bg-zinc-700" />
                <span className="h-3 w-3 rounded-full bg-zinc-700" />
              </div>
              <div className="mx-auto truncate rounded-md bg-background px-3 sm:px-4 py-1 text-[10px] sm:text-xs text-muted-foreground max-w-[60%]">
                app.auditprorx.com/dashboard
              </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-[200px_1fr] gap-0">
              <aside className="hidden md:block border-r border-border p-4 text-left text-sm">
                {[
                  ["Dashboard"],
                  ["Inventory"],
                  ["Audits", true],
      ...
      {/* STATS */}
      <section className="border-b border-border/60">
        <div className="mx-auto grid max-w-[1440px] grid-cols-2 divide-x divide-y divide-border md:grid-cols-4 md:divide-y-0">
          {stats.map(([v, s, l], idx) => (
            <div
              key={l}
              className="px-4 sm:px-7 py-8 sm:py-12 text-center animate-fadeInUp"
              style={{ animationDelay: `${idx * 0.15}s` }}
            >
      ...
      <section className="border-b border-border/60 py-8 sm:py-10">
        <p className="text-center text-[10px] sm:text-xs tracking-[0.3em] text-muted-foreground/70 animate-fadeInUp stagger-0 px-4">
          BUILT FOR MODERN PHARMACY WORKFLOWS
        </p>
        <div className="mt-6 overflow-hidden">
          <div className="marquee-wrapper">
            <div className="marquee-content animate">
              {[
                ...
                <span
                  key={`${t}-1`}
                  className="inline-flex items-center gap-2 rounded-full border border-border bg-surface px-4 py-1.5 text-xs text-muted-foreground animate-fadeInUp whitespace-nowrap"
                  style={{ animationDelay: `${idx * 0.05}s` }}
                >
                  <span className="h-1.5 w-1.5 rounded-full bg-muted-foreground/60" />
                  {t}
              ...
              {[
                ...
                <span
                  key={`${t}-2`}
                  className="inline-flex items-center gap-2 rounded-full border border-border bg-surface px-4 py-1.5 text-xs text-muted-foreground whitespace-nowrap"
                >
                  <span className="h-1.5 w-1.5 rounded-full bg-muted-foreground/60" />
                  {t}
                </span>
      ...
      <section
        id="features"
        className="border-b border-border/60 py-16 sm:py-20 lg:py-24"
      >
        <div className="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-7">
          <div className="text-center">
            <Pill>Platform Capabilities</Pill>
            <h2 className="mt-6 text-3xl sm:text-4xl md:text-5xl font-semibold tracking-tight animate-fadeInUp stagger-1">
              Everything Your Pharmacy Team Needs
            </h2>
            <p className="mx-auto mt-4 max-w-xl text-sm sm:text-base text-muted-foreground animate-fadeInUp stagger-2 px-2">
              Built by pharmacists, for pharmacists. Every capability engineered
              to protect revenue and simplify operations.
            </p>
          </div>
          <div className="mt-10 sm:mt-16 divide-y divide-border/70 border-y border-border/70">
            <div className="grid grid-cols-1 md:grid-cols-2">
              {[
                [
                  FileText,
                ...
                <div
                  key={t}
                  className="group border-b border-border/70 p-5 sm:p-6 animate-fadeInUp transition-colors hover:bg-surface/40"
                  style={{ animationDelay: `${0.1 + idx * 0.08}s` }}
                >
      ...
      <section
        ...
        className="border-b border-border/60 py-16 sm:py-20 lg:py-24"
      >
        <div className="mx-auto grid max-w-[1200px] grid-cols-1 items-center gap-10 lg:gap-12 px-4 sm:px-6 lg:px-7 lg:grid-cols-2">
          <div className="animate-slideInLeft">
            <Pill>Inventory Reports</Pill>
            <h2 className="mt-6 text-3xl sm:text-4xl font-semibold tracking-tight animate-fadeInUp stagger-1">
              Audit Reporting Suite
            </h2>
            <p className="mt-4 text-sm sm:text-base text-muted-foreground animate-fadeInUp stagger-2">
              Generate detailed inventory audit reports that track medication
              inventory, identify discrepancies, and provide actionable
              insights. Our intelligent reporting system delivers comprehensive
              analysis across all pharmacy locations.
          ...
          <div className="rounded-2xl border border-border bg-surface p-4 sm:p-6 animate-slideInRight overflow-x-auto">
            <div className="flex items-start justify-between animate-fadeInUp">
              <div>
                <h4 className="font-semibold">Inventory Reports</h4>
                <p className="text-xs text-muted-foreground">
            ...
            <div className="mt-5 min-w-[640px]">
              <div className="grid grid-cols-[1fr_1fr_0.8fr_0.8fr_0.8fr_1fr_1fr] gap-3 text-[9px] uppercase tracking-wider text-muted-foreground animate-fadeInUp stagger-1 whitespace-nowrap">
                <div>NDC</div>
                <div>Drug Name</div>
                <div>Total Ordered</div>
                <div>Total Billed</div>
            ...
            <div className="mt-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 border-t border-border pt-4 text-xs animate-fadeInUp stagger-9">
              <span className="text-muted-foreground">
                Showing 5 of 240 inventory reports
              </span>
              <button className="self-start sm:self-auto rounded-md border border-border px-3 py-1.5">
                View All Reports
              </button>
            </div>
          </div>
      ...
      <section className="border-b border-border/60 py-16 sm:py-20 lg:py-24">
        <div className="mx-auto grid max-w-[800px] grid-cols-1 items-center gap-12 px-4 sm:px-6 lg:px-7">
          <div className="animate-slideInRight">
            <Pill>Demonstration Walkthrough</Pill>
            <div className="mt-6 relative rounded-2xl border border-border bg-surface-2 overflow-hidden animate-fadeInUp stagger-3">
              <div className="relative w-full aspect-video bg-black flex items-center justify-center">
                <div className="absolute inset-0 bg-gradient-to-br from-zinc-900/80 to-zinc-800/80 flex flex-col items-center justify-center backdrop-blur-sm">
                  <div className="text-center animate-fadeInUp stagger-4 px-4">
                    <Play className="h-12 w-12 sm:h-16 sm:w-16 text-zinc-400 mx-auto mb-4" />
                    <h3 className="text-xl sm:text-2xl font-semibold text-white mb-2 animate-fadeInUp stagger-5">
                      Coming Soon
                    </h3>
                    <p className="text-sm text-zinc-300 animate-fadeInUp stagger-6">
                      Platform demonstration video
      ...
      >
        <div className="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-7">
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-sm sm:text-base text-muted-foreground animate-fadeInUp stagger-2 px-2">
              Search any drug by name, NDC, BIN, PCN, or GROUP and instantly
              surface community-sourced benchmarks — variants, total Rx volume,
              insurance paid, and average reimbursement per unit.
            </p>
          </div>
          <div className="mt-10 sm:mt-14 grid gap-6 lg:grid-cols-[1fr_1.5fr]">
            <div className="space-y-3">
              {[
                [
                  Search,
            ...
            <div className="rounded-2xl border border-border bg-surface p-4 sm:p-6 animate-slideInRight">
              <div className="flex flex-wrap items-center justify-between gap-2 animate-fadeInUp stagger-0">
                <div className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-muted-foreground">
                  <Search className="h-4 w-4" /> Drug Search &amp; Filters
                </div>
                <span className="inline-flex items-center gap-1.5 text-xs text-success">
              ...
              <div className="mt-5 overflow-x-auto rounded-lg border border-border animate-fadeInUp stagger-4">
              ...
              <div className="mt-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1 border-t border-border pt-4 text-xs text-muted-foreground animate-fadeInUp stagger-5">
                <span>Community-sourced · Updated daily</span>
                <span className="text-foreground">
                  Click a row to expand NDC breakdown
                </span>
      ...
      >
        <div className="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-7">
          ...
          <div className="mt-8 grid gap-5 lg:grid-cols-2">
            <div className="rounded-2xl border border-border bg-surface p-4 sm:p-6 animate-slideInLeft">
              <div className="flex flex-wrap items-start justify-between gap-2 animate-fadeInUp stagger-0">
                <div>
                  <h4 className="font-semibold">Your Pharmacy Group</h4>
                  <p className="text-xs text-muted-foreground">
                    Midwest Care Network · 4 pharmacies
              ...
              <div className="mt-5 divide-y divide-border">
                {[
                  ...
                  <div
                    key={r[1]}
                    className="flex flex-wrap items-center gap-3 py-3 animate-fadeInUp"
                    style={{ animationDelay: `${0.1 + idx * 0.1}s` }}
                  >
                    <div className="grid h-9 w-9 shrink-0 place-items-center rounded-lg bg-surface-2 text-sm font-semibold">
                      {r[0]}
                    </div>
                    <div className="min-w-0 flex-1">
                      <div className="text-sm font-medium truncate">{r[1]}</div>
            ...
            <div className="rounded-2xl border border-border bg-surface p-4 sm:p-6 animate-slideInRight">
              ...
              <div className="mt-4 rounded-xl border border-border bg-surface-2/40 p-4 animate-fadeInUp stagger-2">
                ...
                <div className="mt-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 border-t border-border pt-3">
                  <div>
                    <div className="text-[10px] uppercase tracking-wider text-muted-foreground">
                      Holding Pharmacy
                    </div>
      ...
      <section
        ...
        className="border-b border-border/60 py-16 sm:py-20 lg:py-24"
      >
        <div className="mx-auto grid max-w-[1200px] grid-cols-1 items-start gap-10 lg:gap-12 px-4 sm:px-6 lg:px-7 lg:grid-cols-2">
          <div className="animate-slideInLeft">
            <Pill>Reimbursement Intelligence</Pill>
            <h2 className="mt-6 text-3xl sm:text-4xl font-semibold tracking-tight animate-fadeInUp stagger-1">
              Capture High-Value Reimbursement Opportunities
      ...
      {/* HOW IT WORKS */}
      <section className="border-b border-border/60 py-16 sm:py-20 lg:py-24">
        <div className="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-7 text-center">
          <Pill>How It Works</Pill>
          <h2 className="mt-6 text-3xl sm:text-4xl md:text-5xl font-semibold tracking-tight animate-fadeInUp stagger-1">
            Operational in Three Steps
          </h2>
          ...
          <div className="relative mt-10 sm:mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              [
                "01",
                "Register Your Pharmacy",
              ...
              >
                ...
                <div className="rounded-2xl border border-border bg-surface p-6 flex flex-col h-full transition-all hover:shadow-lg hover:border-border/80">
                  <h4
                    className="font-semibold animate-fadeInUp"
                    style={{ animationDelay: `${0.2 + idx * 0.15}s` }}
                  >
      ...
      <section className="border-b border-border/60 py-16 sm:py-20 lg:py-24">
        <div className="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-7 text-center">
          ...
          <p className="mt-4 text-sm sm:text-base text-muted-foreground animate-fadeInUp stagger-2 px-2">
            Hear from the pharmacy operators who rely on AuditProRx every day.
          </p>
          <div className="mt-10 sm:mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {testimonials.map((t, idx) => (
              ...
              >
                ...
                >
                  <div
                    className={`h-9 w-9 shrink-0 rounded-full bg-gradient-to-br ${t.gradient} flex items-center justify-center text-sm font-bold text-white`}
                  >
                    {t.initials}
                  </div>
      ...
      >
        <div className="mx-auto grid max-w-[1200px] grid-cols-1 items-start gap-10 lg:gap-12 px-4 sm:px-6 lg:px-7 lg:grid-cols-2">
            ...
            <ul className="mt-6 space-y-3 text-sm">
              {[
                ...
                <li
                  ...
                  style={{ animationDelay: `${0.3 + idx * 0.1}s` }}
                >
                  <span className="mt-0.5 grid h-5 w-5 shrink-0 place-items-center rounded-full bg-surface-2">
                    <Check className="h-3 w-3 text-success" />
                  </span>
                  {f}
                </li>
          ...
          <div className="rounded-2xl border border-border bg-surface p-4 sm:p-6 animate-slideInRight">
            ...
            <p className="mt-5 flex items-center gap-2 text-xs text-muted-foreground animate-fadeInUp stagger-4">
              <Shield className="h-3.5 w-3.5 shrink-0" /> All sessions are
              encrypted, HIPAA-compliant, and session-logged.
            </p>
          </div>
        </div>
      </section>
      ...
      <section
        ...
        className="border-b border-border/60 py-16 sm:py-20 lg:py-24"
      >
        <div className="mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-7 text-center">
          <Pill>Pricing</Pill>
          <h2 className="mt-6 text-3xl sm:text-4xl md:text-5xl font-semibold tracking-tight animate-fadeInUp stagger-1">
            Transparent, Scalable Pricing
          </h2>
          ...
          <div className="mt-10 sm:mt-14 grid items-stretch gap-6 sm:grid-cols-2 max-w-3xl mx-auto">
            {plans.map((p, idx) => (
              <div
                key={p.id}
                className={`relative flex flex-col rounded-2xl border p-6 sm:p-7 text-left animate-fadeInUp transition-all ${p.highlighted ? "h-[max-content] border-transparent bg-gradient-to-b from-surface-2 to-surface ring-2 ring-foreground/30 shadow-[0_20px_60px_-20px_rgba(0,0,0,0.55)] md:scale-[1.04] md:-my-2 hover:shadow-[0_25px_70px_-20px_rgba(0,0,0,0.65)]" : "border-border bg-surface hover:border-border/80 hover:shadow-md"}`}
                style={{ animationDelay: `${0.1 + idx * 0.15}s` }}
              >
                {p.highlighted && (
                  <span className="absolute -top-3 left-1/2 -translate-x-1/2 rounded-full bg-gradient-to-b from-zinc-100 to-zinc-300 px-3 py-1 text-[10px] font-semibold uppercase tracking-wider text-background shadow-md whitespace-nowrap">
                    {(p as any).badge ?? "Most Popular"}
                  </span>
                )}
                <div
                ...
                >
                  <span
                    className={`font-semibold ${p.highlighted ? "text-4xl sm:text-5xl" : "text-3xl sm:text-4xl"}`}
                  >
                    {p.price}
                  </span>
                  <span className="text-sm text-muted-foreground">
                ...
                {p.id === "base" && p.addOns && (
                  <div className="mt-6">
                    ...
                    >
                      Available Add-ons
                      <ChevronDown
                        className={`h-4 w-4 transition-transform ${expandedAddOns.base ? "rotate-180" : ""}`}
                      />
                    </button>
                    <div
                      className={`expandable-content ${expandedAddOns.base ? "expanded" : ""}`}
                    >
                      <div className="mt-3 space-y-2 border-t border-border pt-4">
                        {p.addOns.map((addon, aIdx) => (
                          <div
                ...
                >
                  <button
                    className={`w-full mt-7 rounded-lg px-4 py-3 text-sm font-medium transition-all animate-fadeInUp ${
                      p.highlighted
                        ? "bg-gradient-to-b from-zinc-100 to-zinc-300 text-background hover:from-white"
                        : "border border-border text-foreground hover:bg-surface-2"
                    }`}
      ...
      <section className="border-b border-border/60 py-16 sm:py-20">
        <div className="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-7">
          <p className="text-center text-[10px] sm:text-xs tracking-[0.3em] text-muted-foreground/70 animate-fadeInUp stagger-0">
            SECURITY & COMPLIANCE STANDARDS
          </p>
          <div className="mt-8 sm:mt-10 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-6">
            {[
              [Shield, "HIPAA Compliant", "Fully certified"],
              [ShieldCheck, "SOC 2 Type II", "Audit verified"],
              [Lock, "AES-256 Encryption", "All data at rest"],
      ...
      {/* CTA */}
      <section className="border-b border-border/60 py-16 sm:py-20 lg:py-24">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-7 text-center">
          <Pill>Get Started</Pill>
          <h2 className="mt-6 text-3xl sm:text-4xl md:text-5xl font-semibold tracking-tight animate-fadeInUp stagger-1">
            Ready to Protect Your Pharmacy Revenue?
          </h2>
          <p className="mx-auto mt-5 max-w-4xl text-sm sm:text-base lg:text-lg leading-relaxed text-muted-foreground animate-fadeInUp stagger-2 px-2">
            Join {stats[2][0]}+ pharmacy groups using AuditProRx to automate
            audits, protect revenue, and gain competitive intelligence. Schedule
            a personalized walkthrough with our team.
          </p>
          <div className="mt-7 sm:mt-9 flex flex-col sm:flex-row items-center justify-center gap-3 animate-fadeInUp stagger-3 flex-wrap">
            <button
              onClick={scheduleConsultation}
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-lg bg-gradient-to-b from-zinc-100 to-zinc-300 px-5 py-3 text-sm font-medium text-background text-center"
            >
              <span>Schedule an Operational Efficiency Review</span>
              <ArrowRight className="h-4 w-4 shrink-0" />
            </button>
            <button
              onClick={handleRequestInfo}
              className="w-full sm:w-auto rounded-lg border border-border bg-surface px-5 py-3 text-sm"
            >
              Request Info
            </button>
          </div>
      ...
      <footer className="py-12 sm:py-14">
        <div className="mx-auto grid max-w-[1280px] grid-cols-2 gap-8 sm:gap-10 px-4 sm:px-6 lg:px-7 md:grid-cols-12">
          ...
          {[
            [
              "Platform",
              ["Audit Management", "Drug Lookup", "Audit Reports", "Pricing"],
            ],
            [
              "Company",
              ["About Us", "Pharmacy Network", "Analytics", "HIPAA Compliant"],
            ],
            [
              "Legal",
              ["Privacy Policy", "Terms of Service", "Cancellation Policy"],
        ...
        <div className="mx-auto mt-10 sm:mt-12 flex max-w-[1280px] flex-col md:flex-row md:items-center md:justify-between gap-4 border-t border-border px-4 sm:px-6 lg:px-7 pt-6 text-xs text-muted-foreground">
          <span>© {currentYear} AuditProRx. All rights reserved.</span>
      ...
      <button
        onClick={() => setIsFaqOpen(true)}
        aria-label="Open FAQs"
        className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-40 grid h-12 w-12 sm:h-14 sm:w-14 place-items-center rounded-full bg-gradient-to-br from-zinc-100 to-zinc-300 text-background shadow-[0_10px_30px_-8px_rgba(0,0,0,0.5)] ring-1 ring-white/10 transition-transform hover:scale-110 active:scale-95 animate-fadeInUp"
      >
      ...
      {isFaqOpen && (
        ...
        >
          <div
            className="relative w-full max-w-2xl rounded-2xl border border-border bg-surface p-5 sm:p-7 shadow-2xl"
            onClick={(e) => e.stopPropagation()}
          >
            <button
              onClick={() => setIsFaqOpen(false)}
            ...
            <div className="flex items-center gap-3 pr-10">
              <div className="grid h-10 w-10 shrink-0 place-items-center rounded-full bg-gradient-to-br from-zinc-100 to-zinc-300 text-background">
                <HelpCircle className="h-5 w-5" />
              </div>
              <div className="min-w-0">
                <h3 className="text-lg sm:text-xl font-semibold tracking-tight">
