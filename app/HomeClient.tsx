...
//             <nav className="mx-auto flex max-w-9xl flex-col gap-1 px-4 py-4 text-sm text-muted-foreground">
//               {navLinks.map((l) => (
//                 <a
//                   key={l.label}
//                   href={l.href}
//                   onClick={() => setIsMobileMenuOpen(false)}
//                   className="rounded-md px-2 py-2 transition hover:bg-surface hover:text-foreground"
//                 >
//                   {l.label}
//                 </a>
//               ))}
...
//         <div className="relative mx-auto max-w-[1440px] px-4 pt-12 pb-12 text-center sm:px-7 sm:pt-20 sm:pb-16">
...
//           <h1 className="mx-auto mt-8 max-w-5xl text-4xl font-semibold leading-[1.1] tracking-tight sm:text-5xl md:text-7xl md:leading-[1.05] animate-fadeInUp stagger-1">
//             Pharmacy Audit Software For
//             <br />
...
//             Pharmacy audit software independent pharmacies use to automate PBM
//             audit defense, wholesaler reconciliation, and NDC inventory audits
//             HIPAA-compliant, built by pharmacists.
//           </p>
//           <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row animate-fadeInUp stagger-4">
//             <button
//               onClick={scheduleConsultation}
...
//             </a>
//           </div>
//           <div className="mt-9 flex flex-wrap items-center justify-center gap-4 text-sm text-muted-foreground animate-fadeInUp stagger-5">
...
//               <aside className="border-b border-border p-4 text-left text-sm md:border-b-0 md:border-r">
//                 {[
//                   ["Dashboard"],
//                   ["Inventory"],
//                   ["Audits", true],
...
//       {/* LEADS */}
//       <section id="leads" className="border-b border-border/60 py-16 sm:py-24">
...
//     "inventory-reports" | "drug-lookup" | "inventory-view" | "leads"
//   >("inventory-reports");
//   const navLinks = [
//     { label: "Capabilities", href: "#features" },
//     { label: "Drug Intelligence", href: "#drug-lookup" },
...
//   const downloadScreenConnect = () => {
//     window.open("https://auditprorx.screenconnect.com/", "_blank");
//   };

//   return (
//     <div
//       className="no-select min-h-screen bg-background text-foreground antialiased"
...
//         <div className="mx-auto flex h-16 max-w-9xl items-center justify-between px-4 sm:px-7">
//           <Logo />
//           <nav className="hidden items-center gap-5 text-sm font-medium text-foreground md:flex lg:gap-8">
//             {navLinks.map((l) => (
//               <a
//                 key={l.label}
//                 href={l.href}
...
//             </span>
//           </h1>
//           <p className="mx-auto mt-7 max-w-3xl text-[15px] leading-relaxed text-white/60 animate-fadeInUp stagger-3">
//             Pharmacy audit software independent pharmacies use to automate PBM
//             audit defense, wholesaler reconciliation, and NDC inventory audits
//             HIPAA-compliant, built by pharmacists.
//           </p>
...
//               target="_blank"
//               // rel="noopener noreferrer"
//               className="cursor-pointer pointer-events-auto relative z-10 inline-flex items-center gap-2 rounded-lg bg-gradient-to-b from-zinc-100 to-zinc-300 px-5 py-3 text-sm font-medium text-background shadow-[inset_0_1px_0_rgba(255,255,255,0.4)] transition hover:from-white"
//             >
//               Schedule a Consultation <ArrowRight className="h-4 w-4" />
//             </a>
//             <a
//               href="#"
//               className="cursor-pointer inline-flex items-center gap-2 rounded-lg border border-border bg-surface px-5 py-3 text-sm text-foreground hover:bg-surface-2"
//             >
//               <Play className="h-4 w-4" /> Watch Overview
//             </a>
//           </div>
...
//               <aside className="border-b border-border p-3 text-left text-sm md:border-b-0 md:border-r">
//                 {(
//                   [
...
//                   ] as const
//                 ).map(([key, label]) => {
//                   const active = activeDashTab === key;
//                   return (
//                     <button
//                       key={key}
//                       type="button"
//                       onClick={() => setActiveDashTab(key)}
//                       className={`mb-1 flex w-full items-center gap-2 rounded-md px-3 py-2 text-left transition cursor-pointer ${
//                         active
...
//               </aside>
//               <div className="p-4 text-left sm:p-6">
//                 {activeDashTab === "inventory-reports" && (
//                   <div>
//                     <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
//                       <div>
//                         <h3 className="font-semibold">Inventory Reports</h3>
//                         <p className="text-xs text-muted-foreground">
//                           Q4 2024 · 240 reports generated
//                         </p>
//                       </div>
//                       <div className="flex gap-2">
//                         <button
//                           type="button"
//                           className="cursor-pointer rounded-md border border-border bg-surface px-3 py-1.5 text-xs text-muted-foreground"
//                         >
//                           Export
//                         </button>
//                         <button
//                           type="button"
//                           className="cursor-pointer rounded-md bg-gradient-to-b from-zinc-200 to-zinc-400 px-3 py-1.5 text-xs font-medium text-background"
//                         >
//                           + New Report
//                         </button>
//                       </div>
...
//                 {activeDashTab === "drug-lookup" && (
//                   <div>
//                     <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
//                       <div>
//                         <h3 className="font-semibold">Drug Intelligence Hub</h3>
//                         <p className="text-xs text-muted-foreground">
//                           Search by NDC, BIN, PCN, GROUP, or drug name
//                         </p>
//                       </div>
//                       <button
//                         type="button"
...
//                         type="text"
//                         readOnly
//                         defaultValue="Mounjaro 5mg/0.5ml"
...
//                     <div className="mt-4 grid grid-cols-2 gap-3 lg:grid-cols-4">
//                       {[
//                         ["Total Rx Volume", "12,480"],
//                         ["Insurance Paid", "$2.4M"],
//                         ["Avg Reimb / Unit", "$184.20"],
//                         ["Verified Variants", "7"],
//                       ].map(([l, v]) => (
//                         <div
//                           key={l}
...
//                         <thead className="bg-surface-2 text-left text-[10px] uppercase tracking-wider text-muted-foreground">
//                           <tr>
//                             {["BIN", "PCN", "GROUP", "Payer", "Avg Paid"].map(
//                               (h) => (
//                                 <th key={h} className="px-4 py-2.5">
//                                   {h}
//                                 </th>
...
//                                 {r[0]}
//                               </td>
//                               <td className="px-4 py-3 font-mono">{r[1]}</td>
...
//                       </button>
//                     </div>
//                     <div className="mt-3 flex items-start gap-2 rounded-lg border border-warning/30 bg-warning/10 px-3 py-2 text-[11px] text-warning">
//                       <AlertTriangle className="mt-0.5 h-3.5 w-3.5 shrink-0" />
//                       <span>
//                         Patient-specific Rx transfers only under DSCSA.
//                         Controlled substances are never listed.
//                       </span>
//                     </div>
//                     <div className="mt-4 space-y-3">
//                       {[
//                         [
//                           "Mounjaro 5mg/0.5ml inj",
//                           "00002-1495-80",
//                           "21",
//                           "Jul 2026",
//                           "$25.00",
...
//                             <button
//                               type="button"
//                               className="cursor-pointer shrink-0 inline-flex items-center gap-1 rounded-md bg-foreground px-2.5 py-1.5 text-[11px] font-medium text-background"
//                             >
...
//                                 Available
//                               </div>
//                               <div className="mt-0.5 font-semibold">{r[2]}</div>
//                             </div>
//                             <div>
//                               <div className="text-[10px] uppercase tracking-wider text-muted-foreground">
//                                 Expiry
//                               </div>
//                               <div className="mt-0.5 font-semibold">{r[3]}</div>
//                             </div>
//                             <div>
//                               <div className="text-[10px] uppercase tracking-wider text-muted-foreground">
//                                 Shelf Cost
//                               </div>
//                               <div className="mt-0.5 font-semibold">{r[4]}</div>
//                             </div>
//                             <div className="truncate">
//                               <div className="text-[10px] uppercase tracking-wider text-muted-foreground">
//                                 Holder
//                               </div>
//                               <div className="mt-0.5 font-semibold truncate inline-flex items-center gap-1">
//                                 {r[5]}
...
//                     <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
//                       <div>
//                         <h3 className="font-semibold">Reimbursement Leads</h3>
//                         <p className="text-xs text-muted-foreground">
//                           Curated opportunities · Updated daily
//                         </p>
//                       </div>
//                       <div className="flex rounded-md border border-border p-0.5 text-xs">
//                         <button
//                           type="button"
//                           className="cursor-pointer rounded bg-surface-2 px-3 py-1"
//                         >
//                           All Regions
//                         </button>
//                         <button
//                           type="button"
//                           className="cursor-pointer px-3 py-1 text-muted-foreground"
//                         >
//                           NJ
//                         </button>
//                         <button
...
//                                 <button
//                                   type="button"
//                                   className="cursor-pointer rounded-md border border-border px-2 py-1 text-[10px] text-foreground hover:bg-surface-2"
//                                 >
//                                   View
//                                 </button>
//                               </td>
...
//       {/* MARQUEE TAGS */}
//       <section className="border-b border-border/60 py-10">
//         <p className="text-center font-semibold text-xs tracking-[0.3em] text-muted-foreground/70 animate-fadeInUp stagger-0">
//           BUILT FOR MODERN PHARMACY WORKFLOWS
//         </p>
//         <div className="mt-6 overflow-hidden">
//           <div className="marquee-wrapper">
...
//                 <span
//                   key={`${t}-1`}
//                   className="inline-flex items-center gap-2 rounded-full border border-white/60 bg-surface px-4 py-1.5 text-xs text-white/60 animate-fadeInUp"
//                   style={{ animationDelay: `${idx * 0.05}s` }}
//                 >
...
//                 <span
//                   key={`${t}-2`}
//                   className="inline-flex items-center gap-2 rounded-full border border-white/60 bg-surface px-4 py-1.5 text-xs text-white/60"
//                 >
//                   <span className="h-1.5 w-1.5 rounded-full bg-white/60" />
//                   {t}
//                 </span>
...
//             <p className="mt-4 text-muted-foreground animate-fadeInUp stagger-2">
//               Our dedicated pharmacy operations team is available Monday through
//               Friday, 10 AM to 5 PM, to provide remote assistance, guided
//               walkthroughs, and immediate issue resolution.
//             </p>
//             <ul className="mt-6 space-y-3 text-sm">
//               {[
  ...
  return (
    ...
    >
      ...
      <section className="relative overflow-hidden border-b border-border/60">
        ...
        <div className="relative mx-auto max-w-[1440px] px-4 pt-10 pb-12 text-center sm:px-7 sm:pt-20 sm:pb-16">
          ...
          <Pill>Enterprise Pharmacy Operations Platform</Pill>
          <h1 className="mx-auto mt-6 max-w-5xl text-[28px] font-semibold leading-[1.15] tracking-tight sm:mt-8 sm:text-5xl md:text-7xl md:leading-[1.05] animate-fadeInUp stagger-1">
            Pharmacy Audit Software For
            <br className="hidden xs:block sm:block" />
            <span className="block text-muted-foreground/70 animate-fadeInUp stagger-2 sm:inline">
              Independent Pharmacies
            </span>
          </h1>
          <p className="mx-auto mt-5 max-w-3xl px-1 text-[14px] leading-relaxed text-white/60 sm:mt-7 sm:text-[15px] animate-fadeInUp stagger-3">
            Pharmacy audit software independent pharmacies use to automate PBM
            audit defense, wholesaler reconciliation, and NDC inventory audits
            HIPAA-compliant, built by pharmacists.
          </p>
          <div className="relative z-20 mt-7 flex w-full flex-col items-stretch justify-center gap-3 sm:mt-9 sm:w-auto sm:flex-row sm:items-center animate-fadeInUp stagger-4">
            ...
            <a
              ...
              className="inline-flex w-full items-center justify-center gap-2 rounded-lg border border-border bg-surface px-5 py-3 text-sm text-foreground transition hover:bg-surface-2 sm:w-auto"
            >
              <Play className="h-4 w-4" /> Watch Overview
            </a>
          </div>
          ...
          <div className="mx-auto mt-16 max-w-5xl overflow-hidden rounded-2xl border border-border bg-surface shadow-2xl animate-scaleIn stagger-6">
            <div className="flex items-center gap-2 border-b border-border bg-surface-2 px-4 py-3">
              ...
              <div className="mx-auto rounded-md bg-background px-4 py-1 text-xs text-muted-foreground">
                auditprorx.com/client-workspace
              </div>
            </div>
            <div className="grid grid-cols-1 gap-0 md:grid-cols-[220px_1fr]">
              <aside className="border-b border-border p-3 text-left text-sm md:border-b-0 md:border-r">
