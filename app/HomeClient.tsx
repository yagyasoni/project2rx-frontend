            ...
            <div className="rounded-2xl border border-border bg-surface p-6 animate-slideInLeft">
              ...
              <div className="mt-5 divide-y divide-border">
                {[
                  ...
                  ["M", "Pharmacy C", "Evanston, IL", "", "Invited", "warning"],
                  [
                    "F",
                    "Pharmacy D",
                    "Schaumburg, IL",
            ...
            <div className="mt-4 space-y-3">
              {[
                ...
                },
                {
                  ...
                  drug: "FLOTREX 0.25MG",
                  sub: "30CT CHEWABLE TABLET",
                  ndc: "59088-0017-54",
                  awp: "$1,995",
                  wac: "$1,604",
                  notes: "Covered on UHC Dual Complete.",
                },
              ].map((r, idx) => (
                <div
                  key={r.title}
          ...
          <div className="mt-14 grid items-stretch gap-6 md:grid-cols-3 max-w-8xl mx-auto">
            {plans.map((p, idx) => (
              ...
              >
                ...
                >
                  <button
                    className={`${p.price === "$399" ? "mt-6" : "mt-4"} w-full rounded-lg px-4 py-3 text-sm font-medium transition-all duration-300 animate-fadeInUp ${
                      p.highlighted
                        ? "bg-gradient-to-b from-zinc-100 to-zinc-300 text-black shadow-md hover:from-white hover:to-zinc-200 hover:shadow-xl"
                        : "border border-zinc-700 bg-transparent text-foreground hover:border-zinc-500 hover:bg-zinc-900/50"
                    }`}
