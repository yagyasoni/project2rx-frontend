      ...
      <section className="relative overflow-hidden border-b border-border/60">
        ...
        <div className="relative mx-auto max-w-[1440px] px-7 pt-20 pb-16 text-center">
          ...
          <h1 className="mx-auto mt-8 max-w-5xl text-6xl font-semibold leading-[1.05] tracking-tight md:text-7xl animate-fadeInUp stagger-1">
            ...
            <br />
            <span className="block text-5xl md:text-6xl text-muted-foreground/70 animate-fadeInUp stagger-2">
        ...
        <div className="mx-auto max-w-[1200px] px-7">
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-xl text-muted-foreground animate-fadeInUp stagger-2">
              Built by pharmacists, for pharmacists. Every capability — from PBM
              audit defense to wholesaler reconciliation — engineered to protect
          ...
          <div className="relative mt-14 grid gap-6 md:grid-cols-3">
            {[
              [
                "01",
                "Connect Your PMS",
                "Securely integrate your pharmacy management system (PrimeRx and other major PMS) and upload wholesaler invoices from McKesson, AXIA, Kinray, and Anda with zero disruption to your existing workflows.",
              ],
              [
                "02",
        ...
        <div className="mx-auto grid max-w-[1280px] grid-cols-2 gap-10 px-7 md:grid-cols-6">
          <div className="col-span-2">
            ...
            <p className="mt-4 max-w-xs text-sm text-muted-foreground">
              Pharmacy audit software trusted by independent pharmacies for PBM
              audit defense, wholesaler reconciliation, and NDC inventory
              audits.
            </p>
            <div className="mt-5 flex gap-2">
              <a
                ...
                aria-label="AuditProRx on LinkedIn"
