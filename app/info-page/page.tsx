...
function isValidDEA(dea: string): boolean {
  ...
  if (!/^[ABFGMPRX][A-Z9]\d{7}$/.test(s)) return false;
...
const PharmacyDetailsForm = () => {
  ...
  const [liabilityInsuranceFile, setLiabilityInsuranceFile] =
    useState<FileUpload>({ file: null, name: "" });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (deaExpiryDate)
      formData.append("deaExpiryDate", deaExpiryDate.toISOString());
                  ...
                  <Popover>
                    <PopoverTrigger asChild>
                      ...
                      >
                        ...
                        {licenseExpiryDate
                          ? format(licenseExpiryDate, "PPP", { locale: enUS })
                          : "Pick a date"}
                      </Button>
                    </PopoverTrigger>
                  ...
                  <Popover>
                    <PopoverTrigger asChild>
                      ...
                      >
                        <Calendar className="mr-2 h-4 w-4" />
                        {deaExpiryDate
                          ? format(deaExpiryDate, "PPP", { locale: enUS })
                          : "Pick a date"}
                      </Button>
                    </PopoverTrigger>
                    <PopoverContent className="w-auto p-0" align="start">
