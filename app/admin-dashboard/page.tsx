    ...
    try {
      ...
      setFetchError(
        err?.response?.data?.error ||
          "Cannot reach API — make sure backend is running on port 5000.",
      );
      setData({
              ...
              <tbody>
                  ...
                  pageRows.map((row, visIdx) => {
                    ...
                    return (
                      <tr
                        key={visIdx}
                        style={{
                          background: visIdx % 2 === 0 ? "#ffffff" : "#f9fafb",
                        }}
                        onMouseEnter={(e) =>
                      ...
                      >
                        ...
                        >
                          {isDirty && (
                            <span style={{ color: "#d97706", marginRight: 2 }}>
                              ●
                            </span>
                          )}
                          {page * PAGE_SIZE + visIdx + 1}
                ...
                {!searchQuery && (
                  <tr>
                    <td
                      colSpan={(data?.headers.length ?? 0) + 2}
                      style={{ padding: 0, borderTop: "1px solid #000000" }}
                    >
                      <button
                        onClick={addRow}
                        style={{
...
export default function AdminDashboardPage() {
  ...
  const handleViewPharmacy = async (user: PharmacyUser) => {
    ...
    try {
      ...
      setToast({
        msg: "Impersonation failed. Please try again.",
        type: "error",
      });
    } finally {
          ...
          >
            {selected ? (
                    ...
                    {[
                      {
                        label: "Full Name",
                        value: selected.name,
                        icon: <Users size={13} color="#6366f1" />,
                      },
                      {
                        label: "Phone Number",
                        value: selected.phone,
                        icon: <Phone size={13} color="#0ea5e9" />,
                      },
                      {
                        label: "Email Address",
                      ...
                      },
                      {
                        ...
                        icon: <Calendar size={13} color="#f59e0b" />,
                      },
                    ].map((item) => (
                      <div
                        key={item.label}
              ...
              >
                ...
                >
                  Click any pharmacy from the list to view their profile and
